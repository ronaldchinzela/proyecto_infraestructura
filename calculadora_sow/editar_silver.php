                        ...
                        <a class="nav-link" href="" data-toggle="collapse" data-target="#collapseLayou" aria-expanded="false" aria-controls="collapseLayou">
                          ...
                          <div class="div-tabla-silver"></i><b id="b-registrar-sow">Editar SOW</b><br><br><br>                          
                            ...
                            <div id="contenedor-tabla-silver">
                                ...
                                <div class="contenedor-editar-silver"> 
                                <form id="form_editar-silver" action="registrar.php" method="POST">
                                ...
                                <input type="submit" value="Registrar" id="boton-editar-sow-silver">
                                <input class="cancelar-editar-silver" type="button" value="Cancelar" onclick="location.href='sow.php'">
                                </div>                             
                                </form>
