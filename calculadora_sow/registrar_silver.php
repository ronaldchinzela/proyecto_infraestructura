                        ...
                        <a class="nav-link" href="" data-toggle="collapse" data-target="#collapseLayou" aria-expanded="false" aria-controls="collapseLayou">
                          ...
                          <div class="div-tabla-silver"></i><b id="b-registrar-sow">Registrar SOW</b><br><br><br>                          
                            ...
                            <div id="contenedor-tabla-silver">
                                ...
                                <div class="contenedor-tablas-silver"> 
                                <form id="form_registrar-silver" action="registrar.php" method="POST">
                                ...
                                <input type="submit" value="Registrar" id="boton-registrar-sow-silver">
                                <input class="cancelar-registrar-silver" type="button" value="Cancelar" onclick="location.href='sow.php'">
                                </div>                             
                                </form>
