                        ...
                        <a class="nav-link" href="" data-toggle="collapse" data-target="#collapseLayou" aria-expanded="false" aria-controls="collapseLayou">
                          ...
                          <div class="div-tabla-silver"></i><b id="b-registrar-sow">Registrar SOW</b><br><br><br>                          
                            ...
                            <div id="contenedor-tabla-silver">
                                ...
                                <div class="contenedor-tablas-bronce"> 
                                <form id="form_registrar-bronce" action="registrar.php" method="POST">
                                ...
                                <input type="submit" value="Registrar" id="boton-registrar-sow-bronce">
                                <input class="cancelar-registrar-bronce" type="button" value="Cancelar" onclick="location.href='sow.php'">
                                </div>                             
                                </form>
